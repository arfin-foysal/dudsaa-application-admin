...
const UpdateJob = ({ handleClose,paramValue }) => {
    ...
    const formik = useFormik({
        ...
        initialValues: {
            ...
            'company_name': paramValue.company_name,
            'image': paramValue.image,
            'position': paramValue.position,
            'vacancy': paramValue.vacancy,
            'link': paramValue.link,
            'location': paramValue.location,
            'job_nature': paramValue.job_nature,
            'remuneration': paramValue.remuneration,
